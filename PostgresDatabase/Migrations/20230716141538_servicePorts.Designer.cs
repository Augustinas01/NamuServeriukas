...
namespace PostgresDatabase.Migrations
{
    ...
    [Migration("20230716141538_servicePorts")]
    partial class servicePorts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Generic.ServiceLocalPort", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("service_local_port_pkey");

                    b.HasIndex("ServiceId")
                        .HasDatabaseName("ix_service_local_port_service_id");

                    b.ToTable("service_local_port", "config");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Generic.ServiceLocalPort", b =>
                {
                    b.HasOne("Domain.Entities.General.Service", "Service")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_service_local_port_services_service_id1");
